...
export default function Applications() {
  ...
  return (
    <Fragment>
        ...
        <main className="page-content">
          <div className="card">
            <div className="content">
              ...
              <p className="copy">A fully-functional clone of an Adidas product page done in Redux.</p><a href="#FEC"><button className="btn1">View</button></a></div>
          </div>
          <div className="card">
            <div className="content">
              <h2 className="title">System Design Capstone</h2>
              <p className="copy">Increased a database to hold 10,000,000 records and horizontally scaled servers for speed.</p><a href="#SDC"><button className="btn1">View</button></a></div>
          </div>
        </main>
      </div>
      <div className="marquee-div">
        <marquee>&lt;React.js&gt;	 &lt;Redux&gt;	 &lt;Node.js&gt;	 &lt;Express&gt;	 &lt;Socket.io&gt;	 &lt;MongoDB&gt;	 &lt;PostgreSQL&gt;</marquee>
      </div>
      <div className="apps">
        <a name="FEC"></a><div className="app-div">
          ...
          <div className="tech-bar">
            <center><p className="tech-used">React.js | Redux | Express.js | MongoDB</p></center>
          </div>
          <div className="app-info">
            <div className="app-bullets">
              <button className="info-button" onClick={showModal}></button>
              <Modal show={isOpen} onHide={hideModal} aria-labelledby="contained-modal-title-vcenter" size="lg" centered>
                <Modal.Header>
      ...
      <div className="apps">
        <a name="SDC"></a><div className="app-div">
          <h1 className="app-text">System Design Capstone</h1>
          <div className="line"></div>
          <video className="video" autoPlay={true} loop={true} muted={true}>
            <source src="sdcvideo.mov" type="video/mp4" />
          </video>
          <div className="tech-bar">
            <p className="tech-used"><center>PostgreSQL | AWS | NodeJS | NGINX</center></p>
          </div>
          <div className="app-info">
            <div className="app-bullets">
              <button className="info-button" onClick={showModal2}></button>
              <Modal show={isOpen2} onHide={hideModal2} aria-labelledby="contained-modal-title-vcenter" size="lg" centered>
                <Modal.Header>
