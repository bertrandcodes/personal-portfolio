...
const SDC = () => (
  <div className={styles.root}>
    ...
    <div className={styles.container}>
      ...
      <h3 className={styles.sectionHeader} id="database">
        Choosing a Database
      </h3>
      <p className={styles.text}>
      ...
      <h3 className={styles.sectionHeader} id="deploying">
      ...
      <h3 className={styles.sectionHeader} id="loadbalancing">
      ...
      <h3 className={styles.sectionHeader} id="caching">
        Caching
      </h3>
      <p className={styles.text}>
