...
const Restocking = () => (
  <div className={styles.root}>
      ...
      <div className={styles.descriptionContainer}>
        <div className={styles.descriptions}>
          ...
          <div>
            ...
            <span className={styles.descriptor2}>Full-Stack Engineer</span>
          </div>
        </div>
    ...
    <img className={styles.image} src="/restocking.jpg" alt="early restocking process at Duffl" />
    ...
    <div className={styles.container}>
      <p className={styles.text}>
        We needed an easy-to-use user interface to present warehouse managers (known as captains)
        with visibility and management options for each product. Within this implementation, we also
        wanted to reduce points of friction from the existing buying/restocking process and empower
        users to make informed decisions by offering algorithmically based recommendations along the
        way.
      </p>
      ...
      <p className={styles.text}>
        ...
        <ul>
          ...
          <li>
            ...
            rest of this article detailing this journey.
          </li>
        </ul>
      </p>
    </div>

    <img className={styles.image} src="/inventoryUI.png" alt="a look at the inventory UI" />
    ...
    <div className={styles.container}>
      <p className={styles.text}>
        ...
        facilitating the restock process down in the warehouse.
      </p>
    </div>
    ...
    <img className={styles.image} src="/ROS.png" alt="equation for rate of sale" />
