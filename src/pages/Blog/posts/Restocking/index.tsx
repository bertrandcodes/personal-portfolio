  ...
  <div className={styles.root}>
    ...
    <div className={styles.descriptionContainer}>
      ...
      <p className={styles.subtext}>
        <i>
          Read about my journey designing and developing custom full-stack software to alleviate the
          growing pains of a $30M delivery startup.
        </i>
      </p>
    </div>
    <h3 className={styles.sectionHeader}>What is Duffl?</h3>
    <p className={styles.text}>
      Duffl is a convenience store delivery service startup for college students boasting a delivery
      to doorstep time of 10 minutes. The company participated in Y Combinator’s W2020 batch and
      raised $12M in Series A funding back in 2021. Currently, Duffl operates at 7 locations across
      3 states. But long before the establishment of large warehouses and streamlined systems came
      humble beginnings.
    </p>
    <h4 className={styles.sectionHeader}>The Early Days</h4>
    <p className={styles.text}>
      Upon the arrival of shipments, each product underwent manual assignment of inventory count and
      location. Locations included shelves, fridges, and freezers of varying sizes which posed space
      constraints issues. We determined future shipments based on the number sold in the previous
      week and naively updated inventory after restocking and sales.
    </p>
    ...
    <div className={styles.text}>
      ...
      <ul>
        ...
        <li>
          The assembly time for couriers to put together an order increased as the store became more
          crowded
        </li>
        <li>
    ...
    <div className={styles.text}>
      ...
      <ul>
        <li>
          Table view with each row representing a “restock order” and relevant column labels between
          tabs.
        </li>
        <li>
          Filter/Unfilter by date function that defaults to the current day. This feature is
          particularly crucial for reviewing past restocked orders for potential issues and planning
          for upcoming buying orders.
        </li>
        <li>
          Debounced search input that sends query params to the backend and receives a filtered set
          of orders to display.
        </li>
        <li>
          Custom pagination component that sends the page number stored in URL param to the backend
    ...
    <p className={styles.text}>
      ...
      together a recommended order for the captain to place with the supplier. The captain can make
      changes they see fit or opt to start a blank order from scratch. This feature reduces user
    ...
    <div className={styles.text}>
      <ol>
        ...
        <li>
          ...
          directly from the restock modal and edit as necessary.
        </li>
        <li>
        ...
        <li>
          Product rows grey out with opacity when completed and once all items have been restocked,
    ...
    <p className={styles.text}>
      ...
      input field. As a result, the table element would rerender leading to a flickering experience
      every time a user typed into the search bar. The solution was to anchor all modals to the
      topmost level of the application and control toggling through React context.
    </p>
    ...
    <p className={styles.text}>
      ...
      rerender of the restock table and cause a flicker. By wrapping the table render function with
      a React.memo(), we successfully prevented rerendering when no props were changed. While
      certainly not everything should be memoized, this was a suitable use case that resulted in a
      bug fix.
    </p>
    <h3 className={styles.sectionHeader}>Backend</h3>
    <p className={styles.text}>
      Our backend is built on top of the Django framework and interfaces with a MySQL database. We
      aimed to implement an intelligent system to guide captains in determining the optimal quantity
      of products for each order. Achieving this would reduce waste, cut down on out-of-stock items,
      lower rates of human error, and overall contribute to a more efficient and streamlined
      ordering process.
    </p>
    ...
    <p className={styles.text}>
      ...
      units sold per hour it is available for purchase. To figure out the amount of time an item is
      live over 24 hours, we looked at “In Stock”/“Out of Stock” and “Store Open”/“Store Close”
    ...
    <p className={styles.text}>
      ...
      store. Factoring in current inventory and the amount already purchased gives us the number of
      units we would need to purchase within an order.
    </p>
    <b>
      <p className={styles.text}>
    ...
    <p className={styles.text}>
      ...
      order then assign them to the new RestockOrder. Finally, we return the ID of the RestockOrder
      and a paginated list of RestockItems with product info, recommended # packs, and pack cost for
      the UI to display.
    </p>
    <img
    ...
    <p className={styles.text}>
      ...
      coupled to our web server and would end up competing for CPU and memory with other application
      functions. To optimize for performance, we offloaded the ROS calculation task to RabbitMQ +
    ...
    <p className={styles.text}>
      ...
      feedback and getting my hands dirty led to numerous improvements in this feature over time and
      certainly added to a sense of reward upon completion. This combined with the opportunity to
      embed technology into one of the most labor-intensive aspects of our operation sets this
